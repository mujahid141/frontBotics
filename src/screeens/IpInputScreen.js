...
export default function IpInputScreen() {
  ...
  const handleSave = async () => {
    ...
    if (!isValidUrl(url)) {
      Alert.alert(
        "Invalid URL",
        "Please enter a valid URL (e.g. https://abc123.ngrok.io)."
      );
      return;
    }
  ...
  return (
    ...
    >
      ...
      <View style={styles.iconContainer}>
        <Icon name="cloud-outline" size={60} color="#2E7D32" />
      </View>
      ...
      <View style={styles.inputContainer}>
        <Icon name="link-outline" size={20} color="#777" style={{ marginRight: 8 }} />
        <TextInput
          style={styles.input}
